...
const DEMO_EVENTS = [
  {
    time: "04:17",
    sev: "serious",
    desc: "North Fence — unexplained motion",
    meta: "zone 3 · cam 7 offline",
    label: "ESCALATED",
  },
  {
    time: "03:42",
    sev: "harmless",
    desc: "North Fence — motion (wind)",
    meta: "zone 3 · 14 m/s gust",
    label: "RESOLVED",
  },
  {
    time: "02:58",
    sev: "minor",
    desc: "Loading Bay — door cycled",
    meta: "bay 2 · unscheduled",
    label: "MONITORING",
  },
  {
    time: "02:11",
    sev: "harmless",
    desc: "Perimeter Gate — access attempt",
    meta: "gate 4 · badge matched",
    label: "RESOLVED",
  },
  {
    time: "01:33",
    sev: "minor",
    desc: "East Compound — heat signature",
    meta: "zone 5 · anomaly flagged",
    label: "REVIEW",
  },
];
...
const DEMO_AGENT = [
  ...
  {
    type: "uncertain",
    text: "? motion source unconfirmed — no access log match",
  },
  {
    type: "tool",
    text: '→ cross_reference_badge_log(zone=3, t="04:05–04:25")',
  },
...
const STAGES = [
  {
    Icon: Plane,
    label: "Patrol",
    desc: "Drones move through your site overnight, capturing sensor events.",
  },
  {
    Icon: Radar,
    label: "Events",
    desc: "Motion, badge swipes, vehicle movement — all ingested and grouped.",
  },
  {
    Icon: Search,
    label: "Investigate",
  ...
  },
  {
    Icon: FileText,
    label: "Briefing",
    desc: "A structured morning briefing, ready for your approval.",
  },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Sentinel monitors overnight events, runs autonomous investigations,
            and prepares a morning-ready briefing — so your team starts the day
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          >
            From patrol to briefing in four stages.
          </h2>
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          >
            Sentinel&apos;s permission model maps to real-world site operations.
          </p>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          >
            ...
            <StepCard
              ...
              ctaLabel="See what's in the wizard →"
              ctaHref="/docs#getting-started"
            />
            <StepCard
              n="03"
              title="Connect your drones"
