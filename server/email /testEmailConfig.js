...
const testEmail = async () => {
  ...
  console.log(
    "🔑 Email Password:",
    "****" + (process.env.EMAIL_PASS?.slice(-4) || "Not set"),
  );
  console.log("\n");
  ...
  try {
    ...
    const testEmailAddress = "chandanjainhp@proton.me"; // Send to user

    const info = await transporter.sendMail({
      from: `${sender.name} <${sender.email}>`,
      to: testEmailAddress,
      subject: "✅ Ridgeway OIP - Email Configuration Test",
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Your Ridgeway OIP application email configuration is working perfectly!</p>
              ...
              <p style="margin-top: 30px; color: #888; font-size: 0.9em;">
                This is an automated test email from your Ridgeway Overnight Intelligence Platform.
              </p>
            </div>
          </div>
        </body>
