...
export default function DroneTimeline() {
  ...
  const cycleSpeed = () =>
    setSpeed(
      (s) =>
        SPEED_OPTIONS[(SPEED_OPTIONS.indexOf(s) + 1) % SPEED_OPTIONS.length],
    );
  ...
  const maxTickPct =
    ticks.length > 0 ? Math.max(...ticks.map((t) => t.pct)) : null;
        ...
        >
          ...
          >
            ...
            <div
              style={{
                ...
                boxShadow:
                  "0 0 0 3px rgba(184,212,232,.18), 0 0 10px rgba(184,212,232,.45)",
                pointerEvents: "none",
                zIndex: 2,
          ...
          >
            {muted ? (
              ...
              >
                <path
                  d="M2 4.5H4L7.5 2V11L4 8.5H2V4.5Z"
                  fill="currentColor"
                  stroke="none"
                  opacity=".45"
                />
